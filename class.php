<?php 
  ...
  // Stores role in a variable
  $role = (string)$_SESSION['role'];

  // Collects all classes from database
...
<body>
  <nav>
    <ul>
      ...
      <!-- Displays only if Role is greater than 2 -->
      <?php if($role > 1 ) { ?>
      <li>
  ...
  <div id="body">
    ...
    <div class="container">
      <div class="row" style="direction:ltl;">
        <?php 
          // Displays all the classes from the database
        ...
        <div class="card border-primary my-4 w-100 mb-1 ">
          <div class="row">
            ...
            <div class="card-body text-white font-weight-bold text-center col-md-9 w-75">
              ...
              <!-- If user selects class then collect classId and takes it to classinfo page -->
