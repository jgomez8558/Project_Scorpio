<?php 
  ...
  // Collects the latest 5 classes to be display
...
<body>
  ...
  <div id="about" class="container-fluid">
    <div class="row">
      <div class="col-sm-8">
        ...
        <h4>A marketplace for learning and teaching locally and online. Students learn new skills and career goals
          taught by experts and professionals in their respective fields who want to develop their teaching skills.</h4><br>
  ...
  <div class="container-fluid bg-grey">
    <div class="row">
      ...
      <div class="col-sm-8">
        <h2>Our Values</h2><br>
        <h4><strong>MISSION:</strong>Providing alternative routes of education for our students, in order to effect the
          best treatment available for all of the individuals and families whose lives may someday be touched by those
          who have come to us for their education and training.</h4><br>
        <p><strong>VISION:</strong> <br>
          ...
          – Provide clear learning outcomes, detailed instruction, and assessment for all courses to ensure course
  ...
  </div><div class="footer-copyright text-center py-3">
