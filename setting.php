      ...
      <div class="col-lg-8 col-md-8 col-sm-12 p-0 m-auto">
        ...
        <div class="card classes">
          ...
          <?php
              ...
              // Displays all classes that user created
          ...
          <div class="card m-3 ">
            <div class="card-body">
              ...
              <a href="edit.php?classId=<?=$row['classId'];?>"> <input name="edit" type="button" class="btn btn-primary"
                  value="Edit" /> </a>
              <a href="delete.php?classId=<?=$row['classId'];?>"> <input name="delete" type="button" class="btn delete"
                  value="Delete" /></a>
            </div>
          </div>
          <?php } ?>
        ...
        <div class="card classes">
          ...
          <div class="card m-3 ">
            <div class="card-body">
              ...
              <a href="unregister.php?classId=<?=$row['classId'];?>"> <input name="delete" type="button" class="btn delete"
                  value="Unregister" /></a>
            </div>
          </div>
          <?php } ?>
